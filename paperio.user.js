// ==UserScript==
// @name         Paper.io ZOOM HACK - Paperio Hacks - Best Paper Cheat 2019 to 2020
// @description  Paperio Mods Features: Zoom Hack, Speed Hack, Unlock All Skins, Auto Spawn, Auto Turn Bot, FPS paper-io.com
...
// @updateURL    https://io-mods.com/mods/paperio.user.js
// @downloadURL  https://io-mods.com/mods/paperio.user.js
// @grant          GM_setValue
// @grant          GM_getValue
// @match        *://paper-io.com/*
// @match        *://paperio.site/*
...
//genel isimlendirme ve ayarlar
 this.st = {
     ...
     liststyler: "color:white;background-color: black;padding:3px;border-style:double;-webkit-box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);-moz-box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);",
 	 imagelist: '<a href="https://www.youtube.com/c/pignuts" target="_blank"><img src="https://iomods.org/mods/youtube.jpg" width="160px" height="40px"></a></br><a href="https://facebook.com/slitherecom" target="_blank"><img src="https://iomods.org/mods/facebook.jpg" width="160px" height="40px"></a>'
 };

//degisenkisimlar
$("#rightbanner").css({"width": "300px"});
if(window.location.href=="https://paperio3.space/" || window.location.href=="https://paperio3.com/" || window.location.href=="https://paperio2.site/") {
$('.center').append('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
} else {
$('#bottom').prepend('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
}
$('#rightbanner').prepend('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('#theme').prepend('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');

if(window.location.href=="https://paper-io.site/") {
$('.leftBlock').prepend('<div class="list1"></div>'+this.st.imagelist+'');
} else { $('#bottom').prepend('<div class="list1"></div>'+this.st.imagelist+''); }

$('.left').prepend('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('.right').prepend('<div class="list1"></div>'+this.st.imagelist+'');
$('.leftbar').remove();
$('#paperio3-com_300x250').remove();
$('.rego1').remove();
...
if(window.location.href=="https://paper-io.site/") {
document.getElementById("bottom").prepend(styleSelect);
} else if(window.location.href=="https://paperio3.space/" || window.location.href=="https://paperio3.com/" || window.location.href=="https://paperio2.site/") {
document.getElementsByClassName("center")[0].appendChild(styleSelect);
} else {
document.getElementById("bottom").appendChild(styleSelect);
}

styleSelect.selectedIndex = GM_getValue("style");
styleSelect.onchange = function() { GM_setValue("style", styleSelect.selectedIndex); }

if(document.getElementById("paperio_p1")) {
var chatInput = document.getElementById('paperio_p1');
} else if(document.getElementById("nickname")) {
    var chatInput = document.getElementById('nickname');
} else {
    var chatInput = document.getElementsByName('nick');
}
...
if(window.location.href=="https://paper-io.site/") {
document.getElementById("bottom").prepend(stylerSelect);
} else if(window.location.href=="https://paperio3.space/" || window.location.href=="https://paperio3.com/" || window.location.href=="https://paperio2.site/") {
document.getElementsByClassName("center")[0].appendChild(stylerSelect);
}
else {
document.getElementById("bottom").appendChild(stylerSelect);
}
...
function changebackground() {
    ...
    $('#bottom').css('background-color',rgbaC2);
$('#right').css('background-color',rgbaC2);
    $('#background').css('background-color',rgbaC2);
       $('#paperio').css('background-color',rgbaC2);
        $('#start-overlay').css('background-color',rgbaC2);
        $('.main').css('background-color',rgbaC2);
}
...
$('#pre_game').css('background-color',rgbaCol);
          $('#bottom').css('background-color',rgbaCol);
$('#right').css('background-color',rgbaCol);
          $('#background').css('background-color',rgbaCol);
                    $('#paperio').css('background-color',rgbaCol);
                    $('#start-overlay').css('background-color',rgbaCol);
          $('.main').css('background-color',rgbaCol);
      }, 3000);
}
